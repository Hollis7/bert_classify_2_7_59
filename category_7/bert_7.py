...
class Dataset(torch.utils.data.Dataset):
    ...
    def __init__(self, split):
        self.all_dataset = load_dataset('csv',
                                        data_files={'train': 'category_7/cate_7_data/train_data3.csv',
                                                    'test': 'category_7/cate_7_data/test_data3.csv',
                                                    'validation': 'category_7/cate_7_data/validation_data3.csv'})
...
for epoch in loop:
    ...
    test_res.append({'model': f'bert_7_epoch{epoch}.pt', 'accuracy': accuracy, 'f1-core': f1_core, 'recall': recall})
